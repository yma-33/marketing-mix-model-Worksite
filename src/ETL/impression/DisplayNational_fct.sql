------------------------------------------------------------
-- DisplayNational FACT
DROP TABLE IF EXISTS mix_media_marketing.DisplayNational_fct
CREATE TABLE IF NOT EXISTS mix_media_marketing.DisplayNational_fct AS
WITH state_frac AS (
...
FROM mix_media_marketing.GiantSpoon_DisplayNational_STG a
JOIN state_frac b
ON 1 = 1
GROUP BY 1,2,3,4,5)
SELECT * FROM joined
