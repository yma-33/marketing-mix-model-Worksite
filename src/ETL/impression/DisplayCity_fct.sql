------------------------------------------------------------
-- DisplayCity FACT
DROP TABLE IF EXISTS mix_media_marketing.DisplayCity_fct
CREATE TABLE IF NOT EXISTS mix_media_marketing.DisplayCity_fct AS
WITH tmp AS (
...
FROM mix_media_marketing.GiantSpoon_DisplayCity_STG
