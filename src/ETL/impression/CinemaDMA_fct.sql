------------------------------------------------------------
-- CinemaDMA FACT
DROP TABLE IF EXISTS mix_media_marketing.CinemaDMA_fct
CREATE TABLE IF NOT EXISTS mix_media_marketing.CinemaDMA_fct AS
SELECT week::date,
		channel,
		campaign,
...
FROM(
    SELECT *
    FROM mix_media_marketing.GiantSpoon_CinemaDMA_STG
